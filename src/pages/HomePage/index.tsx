        ...
        <>
            ...
            <Section marginTop={"0px"} flexDirection='row'>
                ...
                <VideoSlogan backgroundColor='#000' width={'480px'} height={'270px'}>
                    <VideoSlogan backgroundColor='#3c02028c' width={'400px'} height={'230px'}>
                        ...
                        <Button width={"185px"} height={"35px"} margin={"0rem"} color={"#27962D"}>Cadastre-se!</Button>
                    </VideoSlogan>
                </VideoSlogan>
            </Section>
            ...
            <Section marginTop={"30px"} flexDirection='row'>
                ...
                <About width={"600px"}>
                    ...
                    <Button width={"200px"} height={"50px"} margin={"20px"} color={"#27962D"}>Login</Button>
                    <Button width={"200px"} height={"50px"} margin={"20px"} color={"#00377B"}>Formulário</Button>
                    <Button width={"200px"} height={"50px"} margin={"20px"} color={"#E20821"}>Dashboard</Button>
                </About>       
            </Section>
